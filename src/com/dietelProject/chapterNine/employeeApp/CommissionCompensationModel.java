...
public class CommissionCompensationModel extends CompensationModel{
    ...
    public CommissionCompensationModel(String firstName, String lastname, String socialSecurityNumber, double grossSale, double commissionRate) throws IllegalAccessException {
