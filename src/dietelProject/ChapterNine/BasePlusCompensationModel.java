...
public class BasePlusCompensationModel extends CompensationModel{
    private double grossSale;
    private double commissionRate;
    private double baseSalary;

    public BasePlusCompensationModel(String firstName, String lastname, String socialSecurityNumber, double grossSale, double commissionRate, double baseSalary) throws IllegalAccessException {
