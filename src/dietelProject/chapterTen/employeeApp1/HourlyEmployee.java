...
public class HourlyEmployee extends Employee {
    ...
    public HourlyEmployee(String firstName, String lastName, String socialSecurityNumber, double hours, double wage) throws IllegalAccessException {
...
//    }
    ...
    public String toString(){
        return String.format("%s %n%s: %.2f %n%s: %.2f", super.toString(), "Hours", hours, "Earnings", getPaymentAmount());
    }
}
